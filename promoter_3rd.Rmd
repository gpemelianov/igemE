...
igem_obs1 <- data.frame(id, strain, indc, conc, value,
                        valunit, incubhr, incubtemp,
                       device_id, link)

igem_obs2 <- data.frame(id = 1:7,
             strain = c("E. coli", "E. coli","E. coli","E. coli","E. coli","E. coli","E. coli"),
             indc = c("Arabinose","Arabinose","Arabinose","Arabinose","Arabinose","Arabinose","Arabinose"),
             conc = c(0, 0.001, 0.005, 0.01, 0.05, 0.1, 1),
             concunit = rep("mM", length(id)),
             value = c(250, 500, 600, 750, 2000, 5000, 10000),
             valunit = c("a.u."),
